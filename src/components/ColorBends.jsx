...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const start = () => {
      if (rafRef.current !== null || isDisposed) return;
  ...
  }, [bandWidth, enabled, frequency, intensity, iterations, mouseInfluence, noise, parallax, pauseWhenHidden, pixelRatioCap, scale, speed, transparent, warpStrength]);
